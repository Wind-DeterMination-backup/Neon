...
final class GithubUpdateCheck {
    ...
    private static final String repo = "ServerPlayerDataBase";
    private static final String modName = "server-player-database";

    private static final String keyUpdateCheckEnabled = "spdb-updatecheck";
    private static final String keyUpdateCheckShowDialog = "spdb-updatecheck-dialog";
    private static final String keyUpdateCheckLastAt = "spdb-updatecheck-lastAt";
    private static final String keyUpdateCheckIgnoreVersion = "spdb-updatecheck-ignore";
